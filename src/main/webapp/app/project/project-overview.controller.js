...
(function(){
    ...
    function OverviewController($scope) {
        ...
        vm.projectsFlat = navProject() ;
        vm.projects = transformFormat(trimFormat(mockData_ch(), 200), 3);

        function navProject() {
            var projects = mockData_ch();
            ...
            projects.unshift(project_overview);

            angular.forEach(projects, function(value, index){
                var len = projects[index].href.length;
                projects[index].state = projects[index].href.slice(2, len);
            });
            return projects;
        }
        ...
        function mockData_ch() {
            var projects = [
                {
                    'image': 'content/images/medication-image-visualization/Slide13.JPG',
                ...
                {
                    'image': 'content/images/bama/ui/patient-portal/Slide2.jpg',
                    'title': 'Integrated Health Management Cardiac Care Solutions',
                    'description': "There are some key benefits of connection between physician, pa-tient and CHC. Patient gets continual care with personalized intervention tool, physician gets a better overview of patients’ status for better quality of care, meawhile physician collects more data for clinical research, the resource of CHC can be fully leveraged to release overburnden of level 3 hospital.",
                    'href': '#/project-bama'
                },
                {
                    'image': 'content/images/bigdata/Slide10.JPG',
                ...
                {
                    'image': 'content/images/nlp/Slide4.JPG',
                ...
                {
                    'image': 'content/images/breast-cds/Slide5.JPG',
